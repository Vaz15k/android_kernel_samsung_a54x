...
enum is_csi_otf_out_ch {
	CSI_OTF_OUT_SINGLE,
	CSI_OTF_OUT_LONG = CSI_OTF_OUT_SINGLE,
	CSI_OTF_OUT_SHORT,
	CSI_OTF_OUT_MID,
	CSI_OTF_OUT_CH_NUM,
};
...
enum itf_vc_sensor_mode {
	...
	VC_SENSOR_MODE_2PD_MODE3_AND_VPD,
	...
	VC_SENSOR_MODE_IMX_2X2OCL_1_FULL,	/* IMX766 FULL mode  = 505 */
	VC_SENSOR_MODE_IMX_2X2OCL_1_HVBIN,	/* IMX766 HVbin mode = 506 */
	VC_SENSOR_MODE_IMX_2X2OCL_1_VBIN,	/* IMX766 Vbin mode = 507 */
	VC_SENSOR_MODE_IMX_2X2OCL_1_VBIN_BIN,	/* IMX906 IMX882. LRLRLRLRLRLR */
	VC_SENSOR_MODE_IMX_2X2OCL_1_PARTIAL,	/* IMX906 IMX882. RRRRR LLLLL LLLLL RRRRR RRRRR LLLLL LLLLL RRRRR */
...
struct is_sensor_cfg {
	...
	u32 ex_mode_extra;
	bool set_vc;
	u32 img_vc[CSI_OTF_OUT_CH_NUM];
	u32 af_vc[CSI_OTF_OUT_CH_NUM];
	int stat_sensor_mode;
};
...
#define IS_HOTJOIN_CHK_DTIME	3000
...
struct is_module_enum {
	...
	struct delayed_work			hotjoin_chk_dwork;
};
