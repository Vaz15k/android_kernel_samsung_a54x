...
#define SW_SYNC_ADJUST_CRITERIA		(1 * 1000 * 1000) /* 1ms */
#define SW_SYNC_ADJUST_MAX_CRITERIA	(10 * 1000 * 1000) /* 10ms */
#define SW_SYNC_24FPS_DURATION		(41666666)
#define SW_SYNC_10FPS_DURATION		(100000000)
#define SW_SYNC_MAX_DURATION		(150000000)
#else
...
struct is_cis {
	...
	const struct sensor_reg_addr	*reg_addr;
	const struct sensor_cis_info	*sensor_info;
	void				*priv_runtime;
...
#if IS_ENABLED(USE_OIS_HALL_DATA_FOR_VDIS)
...
struct is_laser_af {
	...
	spinlock_t			laf_work_lock;
	struct workqueue_struct		*workqueue;
	struct work_struct		start_work;
	struct work_struct		stop_work;
	struct work_struct		get_distance_work;
};
