...
#define V4L2_CID_IS_S_LLC_CONFIG		(V4L2_CID_FIMC_IS_BASE + 30)
#define V4L2_CID_IS_G_CAP_META_UPDATE		(V4L2_CID_FIMC_IS_BASE + 31)
...
#define V4L2_CID_IS_G_SNR_STATUS		(V4L2_CID_FIMC_IS_BASE + 57)
...
#define V4L2_CID_IS_FAST_CTL_LENS_POS		(V4L2_CID_FIMC_IS_BASE + 63)
...
#define V4L2_CID_IS_S_DVFS_SCENARIO	(V4L2_CID_FIMC_IS_BASE + 84)
#define V4L2_CID_IS_S_DVFS_RECORDING_SIZE (V4L2_CID_FIMC_IS_BASE + 85)
#define V4L2_CID_IS_G_OFFLINE_DATA		(V4L2_CID_FIMC_IS_BASE + 86)
#define V4L2_CID_IS_S_OD_DATA			(V4L2_CID_FIMC_IS_BASE + 87)
#define V4L2_CID_IS_OBTE_CONFIG			(V4L2_CID_FIMC_IS_BASE + 100)

#define V4L2_CID_IS_S_IRTA_RESULT_BUF		(V4L2_CID_FIMC_IS_BASE + 200)
#define V4L2_CID_IS_S_IRTA_RESULT_IDX		(V4L2_CID_FIMC_IS_BASE + 201)
#define V4L2_CID_IS_S_CRTA_START		(V4L2_CID_FIMC_IS_BASE + 202)
...
enum is_opening_hint {
	...
	IS_OPENING_HINT_FASTEN_AE_VIDEO,
	IS_OPENING_HINT_TO_REMOSAIC,
	IS_OPENING_HINT_MAX,
};
...
enum is_closing_hint {
	...
	IS_CLOSING_HINT_REOPEN,
	IS_CLOSING_HINT_FROM_TETRA,
	IS_CLOSING_HINT_MAX,
};

#define V4L2_CID_IS_ICPU_PRELOAD		(V4L2_CID_FIMC_IS_BASE + 672)
enum is_icpu_preload {
	IS_ICPU_PRELOAD_OFF = 0,
	IS_ICPU_PRELOAD_ON = 1,
	IS_ICPU_PRELOAD_MAX,
};

#define V4L2_CID_IS_HF_MAX_SIZE			(V4L2_CID_FIMC_IS_BASE + 680)
#define V4L2_CID_IS_YUV_MAX_SIZE		(V4L2_CID_FIMC_IS_BASE + 681)
...
#define V4L2_CID_SENSOR_SET_EXTENDED_MODE		(V4L2_CID_SENSOR_BASE + 21)
#define V4L2_CID_SENSOR_SET_TOF_AUTO_FOCUS		(V4L2_CID_SENSOR_BASE + 22)
#define V4L2_CID_SENSOR_SET_TOF_INFO		        (V4L2_CID_SENSOR_BASE + 23)
#define V4L2_CID_SENSOR_SET_CAPTURE_INTENT_INFO		(V4L2_CID_SENSOR_BASE + 24)
#define V4L2_CID_SENSOR_SET_LASER_MODE                  (V4L2_CID_SENSOR_BASE + 25)
#define V4L2_CID_SENSOR_SET_EXTENDED_MODE_EXTRA		(V4L2_CID_SENSOR_BASE + 26)
#define V4L2_CID_SENSOR_SET_EXTENDED_MODE_FORMAT	(V4L2_CID_SENSOR_BASE + 27)
#define V4L2_CID_SENSOR_SET_FLASH_FASTSHOT              (V4L2_CID_SENSOR_BASE + 28)
...
#define V4L2_CID_SENSOR_GET_SSM_FLICKER			(V4L2_CID_SENSOR_BASE + 133)
#define V4L2_CID_SENSOR_SET_SSM_DEBUG_CONTROL		(V4L2_CID_SENSOR_BASE + 134)
#define V4L2_CID_SENSOR_GET_CAL_SIZE			(V4L2_CID_SENSOR_BASE + 136)
#define V4L2_CID_SENSOR_GET_CAL_DATA			(V4L2_CID_SENSOR_BASE + 137)
#define V4L2_CID_SENSOR_SET_CAL_POS			(V4L2_CID_SENSOR_BASE + 138)
#define V4L2_CID_SENSOR_GET_UPDATED_BINNING_RATIO	(V4L2_CID_SENSOR_BASE + 139)
...
#define V4L2_CID_SENSOR_GET_BAYER_ORDER			(V4L2_CID_SENSOR_BASE + 142)

/* get sensor informatio for sensor manager */
#define V4L2_CID_SENSOR_GET_SENSOR_NUMBER		(V4L2_CID_SENSOR_BASE + 143)
#define V4L2_CID_SENSOR_GET_SENSOR_INFO			(V4L2_CID_SENSOR_BASE + 144)
#define V4L2_CID_SENSOR_GET_SENSOR_MODES		(V4L2_CID_SENSOR_BASE + 145)

#define V4L2_CID_SENSOR_GET_CUR_HDR_MODE		(V4L2_CID_SENSOR_BASE + 146)
#define V4L2_CID_SENSOR_SET_AUTO_FRAMING                (V4L2_CID_SENSOR_BASE + 147)
#define V4L2_CID_SENSOR_SET_BAYER_ORDER			(V4L2_CID_SENSOR_BASE + 148)
...
#define V4L2_CID_EEPROM_GET_OTP_STATUS			(V4L2_CID_SENSOR_BASE + 311)

#define V4L2_CID_IS_OIS_GET_ACCSRXY			(V4L2_CID_SENSOR_BASE + 312)
#define V4L2_CID_IS_EEPROM_GET_OIS_TILTSRXY		(V4L2_CID_SENSOR_BASE + 313)
#define V4L2_CID_IS_EEPROM_GET_OIS_GOFFSETXY		(V4L2_CID_SENSOR_BASE + 314)
#define V4L2_CID_IS_EEPROM_GET_OIS_GGAINX		(V4L2_CID_SENSOR_BASE + 315)
#define V4L2_CID_IS_EEPROM_GET_OIS_GGAINY		(V4L2_CID_SENSOR_BASE + 316)
#define V4L2_CID_IS_OIS_GET_FWVERSION			(V4L2_CID_SENSOR_BASE + 317)
#define V4L2_CID_IS_OIS_SET_GGAINX			(V4L2_CID_SENSOR_BASE + 318)
#define V4L2_CID_IS_OIS_SET_GGAINY			(V4L2_CID_SENSOR_BASE + 319)
#define V4L2_CID_IS_OIS_FW_UPDATE			(V4L2_CID_SENSOR_BASE + 320)
#define V4L2_CID_IS_OIS_OFFSET_CAL			(V4L2_CID_SENSOR_BASE + 321)
#define V4L2_CID_IS_OIS_GET_FLASH_GOFFSETXY		(V4L2_CID_SENSOR_BASE + 322)
#define V4L2_CID_IS_OIS_GET_FLASH_GGAINX		(V4L2_CID_SENSOR_BASE + 323)
#define V4L2_CID_IS_OIS_GET_FLASH_GGAINY		(V4L2_CID_SENSOR_BASE + 324)
#define V4L2_CID_IS_OIS_SET_CAL_DONE			(V4L2_CID_SENSOR_BASE + 325)
#define V4L2_CID_IS_OIS_GET_EIS_BUF			(V4L2_CID_SENSOR_BASE + 326)
#define V4L2_CID_IS_OIS_GET_IC_TYPE			(V4L2_CID_SENSOR_BASE + 327)
#define V4L2_CID_EEPROM_GET_XTALK			(V4L2_CID_SENSOR_BASE + 328)
#define V4L2_CID_IS_OIS_SET_ACC				(V4L2_CID_SENSOR_BASE + 329)
...
#define V4L2_CID_CAMERAPP_VRA_MODEL_CONTROL	(V4L2_CID_CAMERAPP_BASE + 6)
...
/* Split R, G, B, 12bit Packed, Single plane */
#define V4L2_PIX_FMT_SRGB36P_SP		v4l2_fourcc('S', 'R', 'P', '6')
/* Split R, G, B, 12bit unpacked, Single plane */
#define V4L2_PIX_FMT_SRGB36_SP		v4l2_fourcc('S', 'R', '6', 'S')
/* Split R, G, B, 8bit, Single plane */
#define V4L2_PIX_FMT_SRGB24_SP		v4l2_fourcc('S', 'R', '2', '4')
/* R, G, B, 8bit, interleaved, Single plane */
#define V4L2_PIX_FMT_RGB24I_SP		v4l2_fourcc('R', '2', '4', 'I')
