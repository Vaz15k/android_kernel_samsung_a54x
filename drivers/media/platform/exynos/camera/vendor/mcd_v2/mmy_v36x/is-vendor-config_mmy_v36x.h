...
#define USE_OIS_EXTERNAL_PU

#define PLACE_OIS_CENTERING_AFTER_OIS_INIT
#define SKIP_AF_MOVE_FOR_DW_ACTUATOR_IN_OIS_AUTOTEST
#define CLEAR_OIS_PREV_STATE
#define SET_OIS_SPI_PUD_IN_M36X
#define RESET_OIS_WHEN_AUTOTEST_FAILED
#define RESET_OIS_WHEN_SELFTEST_FAILED
#define RESET_OIS_WHEN_CALIBRATIONTEST_FAILED

/* Temp code */
#define USE_OIS_DEBUGGING_LOG
