...
static const struct proc_ops abox_log_fops = {
	.proc_open = abox_log_file_open,
	.proc_release = abox_log_file_release,
	.proc_read = abox_log_file_read,
	.proc_poll = abox_log_file_poll,
